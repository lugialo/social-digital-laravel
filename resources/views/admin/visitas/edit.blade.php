    ...
    <form action="{{ route('admin.visitas.update', $visita) }}" method="POST">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="membro" class="form-control @error('membro') is-invalid @enderror"
                       value="{{ old('membro', $visita->membro) }}" required>
        ...
        <div class="form-row">
            <div class="form-group col-md-8">
                ...
                <input type="text" name="logradouro" class="form-control @error('logradouro') is-invalid @enderror"
                       value="{{ old('logradouro', $visita->logradouro) }}" required>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" name="numero" class="form-control @error('numero') is-invalid @enderror"
                       value="{{ old('numero', $visita->numero) }}">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="text" name="bairro" class="form-control @error('bairro') is-invalid @enderror"
                       value="{{ old('bairro', $visita->bairro) }}">
        ...
        <div class="form-group">
            ...
            <textarea name="descricao" rows="3"
                      class="form-control @error('descricao') is-invalid @enderror">{{ old('descricao', $visita->descricao) }}</textarea>
        ...
        <div class="form-group">
            ...
            <textarea name="observacao" rows="3"
                      class="form-control @error('observacao') is-invalid @enderror">{{ old('observacao', $visita->observacao) }}</textarea>
